...
const LoginPage = () => {
  ...
  const onSubmitHandler = (e) => {
    ...
    // TODO: wire up real signup/login API call
    console.log({ currState, fullName, email, password, bio })
  }

  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl bg-black'>
